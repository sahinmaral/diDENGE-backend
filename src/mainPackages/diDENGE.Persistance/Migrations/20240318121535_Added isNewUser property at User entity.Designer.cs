...
namespace diDENGE.Persistance.Migrations
{
    ...
    [Migration("20240318121535_Added isNewUser property at User entity")]
    partial class AddedisNewUserpropertyatUserentity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Security.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ad5a1322-054f-4117-b960-5aafb23ab9bd",
                            ConcurrencyStamp = "80b0c48d-2711-411c-a967-7d9310eed698",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
